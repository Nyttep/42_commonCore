...
then
	...
	wp core install --allow-root --path=/var/www/wordpress --url=$DOMAIN_NAME --title=Pdubois --admin_user=$WP_ADMIN_USER --admin_password=$WP_ADMIN_PSWD --admin_email=$WPADMIN_EMAIL --skip-email
