...
sleep 4
wp-cli.phar core install     --url=$DOMAIN_NAME --title=Pdubois --admin_user=$WP_ADMIN_USER --admin_password=$WP_ADMIN_PSWD --admin_email=$WP_ADMIN_EMAIL --skip-email --allow-root --path='/var/www/wordpress'
